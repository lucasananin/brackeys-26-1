...
namespace TarodevController
{
    ...
    public class PlayerController : MonoBehaviour, IPlayerController
    {
        ...
        private void ExecuteJump()
        {
            ...
            var _gravity = _stats.FallAcceleration;
            var _jumpVelocity = Mathf.Sqrt(2f * _stats.jumpHeight * Mathf.Abs(_gravity));
        ...
        private void HandleDirection()
        {
            ...
            {
                var _speed = _stats.MaxSpeed * _speedBuff;
                _frameVelocity.x = Mathf.MoveTowards(_frameVelocity.x, _frameInput.Move.x * _speed, _stats.Acceleration * Time.fixedDeltaTime);
            }
        }
